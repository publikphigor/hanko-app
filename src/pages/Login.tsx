...
import { logo, iphone, avatar } from '@images/index';
...
const Login = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-full">
      <div className="w-1/2 bg-light-bg flex center-child text-center p-[80px] relative">
        <div className="mx-auto flex flex-col gap-5 h-full center-child">
          <div className="w-[230px] h-[267px] mx-auto">
            <img src={iphone} alt="iphone" className="parent-full block object-contain" />
          </div>
          <h1 className="font-bold text-2xl">Simplifying tasks management</h1>
          <p className="text-sm max-w-[367px] mx-auto">
          ...
          <div className="absolute bottom-[80px] left-1/2 -translate-x-1/2 flex flex-col gap-5">
            <div className="w-[192px] mx-auto">
              <img src={avatar} alt="logo" className="parent-full block object-contain" />
            </div>
            <p className="text-sm">Trusted by 50k+ users</p>
          </div>
        </div>
      </div>
      <div className="flex  h-full w-1/2 center-child bg-white">
        <div>
          <div className="w-[160px] mx-auto mb-[56px]">
            <img src={logo} alt="logo" className="parent-full block object-contain" />
          </div>
          <hanko-auth />
        </div>
      </div>
